...
<div class="row">
  <div class="col-md-4">
    <img src="uploads/posters/<?= $movie['poster'] ?>" class="img-fluid" alt="<?= htmlspecialchars($movie['title']) ?>">
  </div>
  <div class="col-md-8">
    <h1><?= htmlspecialchars($movie['title']) ?></h1>
    <p><strong>Release Year:</strong> <?= date('Y', strtotime($movie['release_date'])) ?></p>
    <p><strong>Rating:</strong> <?= $movie['rating'] ?></p>
    <p><strong>Genre:</strong> <?= $movie['genre_id'] ?></p>
    <p><strong>Studio:</strong> <?= $movie['studio_id'] ?></p>
