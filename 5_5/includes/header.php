    ...
    <div class="container d-flex justify-content-between">
      ...
      <form class="d-flex ms-auto" action="search.php" method="get" role="search">
        <div class="position-relative">
          <input type="text" id="search" name="q" value="<?= htmlspecialchars($filters['q']) ?>" class="form-control" autocomplete="off" placeholder="Search movies...">
          <ul id="suggestions" class="list-group position-absolute top-100 start-0"></ul>
        </div>
